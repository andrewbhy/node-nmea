...
var NMEA = ( function() {
    ...
    //BD for Beidou Satellites
    //GP for GPS Satellites
    //GN for GNSS constellation (GPS+GLONASS)
    //GL for GLONASS Satellites
    //II Integrated Instrumentations
    //WI Weather Instrumnets


    //GGA Sentences
    nmea.addParser(new GGA.Decoder("BDGGA"));
    nmea.addParser(new GGA.Decoder("GPGGA"));
    nmea.addParser(new GGA.Decoder("GNGGA"));
    nmea.addParser(new GGA.Decoder("GLGGA"));

    //RMC Sentences
    nmea.addParser(new RMC.Decoder("BDRMC"));
    nmea.addParser(new RMC.Decoder("GPRMC"));
    nmea.addParser(new RMC.Decoder("GNRMC"));
    nmea.addParser(new RMC.Decoder("GLRMC"));

    //GSV Sentences
    nmea.addParser(new GSV.Decoder("BDGSV"));
    nmea.addParser(new GSV.Decoder("GPGSV"));
    nmea.addParser(new GSV.Decoder("GNGSV"));
    nmea.addParser(new GSV.Decoder("GLGSV"));

    //GSA Sentences
    nmea.addParser(new GSA.Decoder("GPGSA"));
    nmea.addParser(new GSA.Decoder("GNGSA"));
    nmea.addParser(new GSA.Decoder("BDGSA"));
    nmea.addParser(new GSA.Decoder("GLGSA"));

    //VTG Sentences
    nmea.addParser(new VTG.Decoder("GPVTG"));
    nmea.addParser(new VTG.Decoder("GLVTG"));
    nmea.addParser(new VTG.Decoder("GNVTG"));
    nmea.addParser(new VTG.Decoder("BDVTG"));

    //GLL Sentences
    nmea.addParser(new GLL.Decoder("GPGLL"));
    nmea.addParser(new GLL.Decoder("GNGLL"));
    nmea.addParser(new GLL.Decoder("GLGLL"));
    nmea.addParser(new GLL.Decoder("BDGLL"));

    //GST Sentences
    nmea.addParser(new GST.Decoder("GPGST"));
    nmea.addParser(new GST.Decoder("GNGST"));
    nmea.addParser(new GST.Decoder("GLGST"));
    nmea.addParser(new GST.Decoder("BDGST"));

    //ZDA Senetences
    nmea.addParser(new ZDA.Decoder("GPZDA"));
    nmea.addParser(new ZDA.Decoder("GNZDA"));
    nmea.addParser(new ZDA.Decoder("GLZDA"));
